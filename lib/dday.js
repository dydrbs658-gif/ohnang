...
export const CATEGORY_CONFIG = {
  fridge:     { emoji: '🥦', label: '냉장',   bg: '#EFF4FF' },
  freezer:    { emoji: '🧊', label: '냉동',   bg: '#F0F9FF' },
  pantry:     { emoji: '🥫', label: '실온',   bg: '#FFFBEB' },
  supplement: { emoji: '💊', label: '영양제', bg: '#F0FDF4' },
  etc:        { emoji: '📦', label: '기타',   bg: '#F4F6FA' },
};
